...
import { slugToSubCategory, slugToCategory } from '@/lib/product-categories';
...
interface AltKategoriSlugContentProps {
    kategoriSlug: string;
    altKategoriSlug: string;
}

export default function AltKategoriSlugContent({ kategoriSlug, altKategoriSlug }: AltKategoriSlugContentProps) {
