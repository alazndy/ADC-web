...
export default function TeknolojiCozumleriSlugContent({ slug }: { slug: string }) {
    if (slug === 'telematik-ve-filo-yonetimi') {
    ...
    const service = techSolutions.find(p => p.slug === slug);
